...
class Page2 extends JFrame implements ActionListener,MouseListener{
	...
	JLabel head = new JLabel("please specify the format in which you want to view files:");
        ...
        //labels for the empty page of instructors:
        JLabel inst_label1 = new JLabel("THERE ARE 22 TEACHERS OF  CSE. DEPARTMENT ");
	JLabel inst_label2 = new JLabel("YOU CAN EXPORT OR VERIFY THE ROUTINE GENERATED AS PER ROOM FROM THIS WINDOW");
        
        //labels for the empty page of rooms:
        JLabel room_label1 = new JLabel("THE ROOMS OF CSE DEPARTMENT ARE ENLISTED HERE ");
	JLabel room_label2 = new JLabel("YOU CAN EXPORT OR VERIFY THE ROUTINE GENERATED AS PER ROOM FROM THIS WINDOW");
        
        //labels for the empty page of rooms:
        JLabel section_label1 = new JLabel("THERE ARE 6 SECTIONS IN EACH YEAR IN CSE DEPT.");
	JLabel section_label2 = new JLabel("YOU CAN EXPORT OR VERIFY THE ROUTINE GENERATED AS PER ROOM FROM THIS WINDOW");
   ...
   /* TableColumn tr;
    ...
    jt.setShowVerticalLines(false);
		...
		f_instRoutine.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                ...
                inst_label1.setBounds(100,150,1000,150);
                inst_label1.setFont(f5);
                
                inst_label2.setBounds(100,300,1000,150);
                inst_label2.setFont(f5);
		...
		cont_instRoutine.add(back_inst);
                cont_instRoutine.add(inst_label1);
                cont_instRoutine.add(inst_label2);
    ...
    JScrollPane sp=new JScrollPane(jt);
		...
		f_roomRoutine.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                ...
                room_label1.setBounds(100,150,1000,150);
                room_label1.setFont(f5);
                
                room_label2.setBounds(100,300,1000,150);
                room_label2.setFont(f5);
		...
		cont_roomRoutine.add(back_room);
                cont_roomRoutine.add(room_label1);
                cont_roomRoutine.add(room_label2);
   ...
   //     System.out.println("in here "+temps[0]+" "+temps[1]+" "+temps[2]);
    ...
    jt.setShowVerticalLines(false);
		...
		section_label1.setBounds(100,150,1000,150);
                section_label1.setFont(f5);
                
                section_label2.setBounds(100,300,1000,150);
                section_label2.setFont(f5);
		...
		cont_sectionRoutine.add(back_section);
                cont_sectionRoutine.add(section_label1);
                cont_sectionRoutine.add(section_label2);
